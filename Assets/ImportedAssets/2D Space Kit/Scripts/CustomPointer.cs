...
public class CustomPointer : MonoBehaviour
{
    ...
    public bool invert_y_axis = false;
    ...
    public bool use_gamepad_input = false;
    public bool use_mouse_input = false; //Pointer will be controlled by the mouse.
                                         //Pointer will be controlled by a joystick
                                         //Pointer will drift to the center of the screen (Use this for joysticks)
